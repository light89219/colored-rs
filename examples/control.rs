...
fn main() {
    ...
    colored_rs::control::set_virtual_terminal(true);
    println!("{}", "stdout: Virtual Terminal is in use".bright_green());
    colored_rs::control::set_virtual_terminal(false);
    println!(
        "{}",
...
fn both() {
    ...
    colored_rs::control::set_override(true);
    println!("{}", "some warning".yellow());
    // now, this will be never yellow
    colored_rs::control::set_override(false);
    println!("{}", "some warning".yellow());
    // let the environment decide again
    colored_rs::control::unset_override();
}
